    ...
    <>
      <nav className="gc-navbar" ref={navRef as any}>
        ...
        <div className="gc-navlinks">
          ...
          <Link to="/readings" className={`gc-navlink ${isActive('/readings') ? 'active':''}`} onMouseEnter={() => import('../../features/readings/ReadingsPage')} style={isActive('/readings') ? ({ color:'#ffffff', WebkitTextFillColor:'#ffffff' } as any) : undefined}>Daily Word</Link>
        ...
        >
          ...
          <nav className="gc-drawer__panel" role="navigation" aria-label="Mobile menu">
            <div className="gc-drawer__links">
              ...
              <Link to="/readings" onClick={closeDrawer} className={`gc-navlink ${isActive('/readings') ? 'active':''}`}>Daily Word</Link>
