    ...
    <>
      <nav className="gc-navbar" ref={navRef as any}>
        ...
        <div className="gc-navlinks">
          ...
          <Link to="/readings" className={`gc-navlink ${isActive('/readings') ? 'active':''}`} onMouseEnter={() => import('../readings/ReadingsPage')} style={isActive('/readings') ? ({ color:'#ffffff', WebkitTextFillColor:'#ffffff' } as any) : undefined}>Daily Word</Link>
