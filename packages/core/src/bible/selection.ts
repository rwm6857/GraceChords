...
// Book names are always spelled in full, exactly as BOOKS in songs/verseRef.js
// lists them -- "Psalms 1", never "Ps 1". Abbreviating only a couple of books
// reads as a bug next to the 64 that stay full-length.
