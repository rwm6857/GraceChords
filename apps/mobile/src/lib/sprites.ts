...
// never React Native's `Image`: RN decodes WebP on Android only (see the format
// list in Libraries/Image/ImageProps.js), and that asymmetry once shipped as
// blank circles on iOS in the profile card, the Home header, and an avatar
// picker whose tiles were invisible apart from the selected one's ring.
//
